...
class CZIReader(generalIO.GeneralReader):
    ...
    def readHeader(self):
        ...
        try:
            self.optics_data['na'] = meta['ImageDocument']['Metadata']['Information']['Instrument']['Objectives']['Objective']['LensNA']
            self.optics_data['n1'] = img['ObjectiveSettings']['RefractiveIndex']
        except KeyError:
            pass
